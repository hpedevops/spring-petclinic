...
"""
  ...
  environment {
    ...
    MATTERMOST_WEBHOOK = "https://mattermost.mgt.green.perspectatechdemos.com/hooks/4xxb8iefaf8b8jy9etz6jbdaer"
    ...
    BUILD_URL = "https://jenkins.mgt.green.perspectatechdemos.com/job/brown-redcloud3/job/spring-petclinic/job/${BRANCH_NAME}/${BUILD_NUMBER}"
    DEV_DEPLOYMENT_URL = "https://brown-redcloud3-spring-petclinic.dev.green.perspectatechdemos.com"
    TEST_DEPLOYMENT_URL = "https://brown-redcloud3-spring-petclinic.test.green.perspectatechdemos.com"
    PROD_DEPLOYMENT_URL = "https://brown-redcloud3-spring-petclinic.prod.green.perspectatechdemos.com"
